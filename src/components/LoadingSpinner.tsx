  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-4 py-8">
      ...
      <div className="relative">
        ...
        } border-4 rounded-full animate-spin`}></div>
        
        {/* Particules flottantes autour du spinner */}
        {!contrastHigh && (
          <div className="absolute inset-0">
            <div className="absolute top-0 left-1/2 w-2 h-2 bg-blue-400 rounded-full animate-ping" 
                 style={{animationDelay: '0s'}}></div>
            <div className="absolute top-1/2 right-0 w-1 h-1 bg-purple-400 rounded-full animate-ping" 
                 style={{animationDelay: '0.5s'}}></div>
            <div className="absolute bottom-0 left-1/2 w-1.5 h-1.5 bg-indigo-400 rounded-full animate-ping" 
                 style={{animationDelay: '1s'}}></div>
            <div className="absolute top-1/2 left-0 w-1 h-1 bg-cyan-400 rounded-full animate-ping" 
