...
export function BibleApiTest() {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      {/* Test des livres */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold mb-2">Versions disponibles ({bibles.length})</h3>
        <button 
      ...
      <div className="mb-6">
        ...
        {verses.length > 0 && (
          <div className="space-y-2">
            {verses.map(verse => (
              <div key={`${verse.book_id}-${verse.chapter}-${verse.verse_start}`} className="p-3 bg-gray-50 rounded border-l-4 border-blue-500">
