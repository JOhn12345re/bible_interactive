      ...
      >
        <div className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white rounded-lg shadow-2xl p-4 max-w-sm border-2 border-yellow-300">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div
              className="absolute top-2 left-4 w-2 h-2 bg-yellow-200 rounded-full animate-ping"
            ...
            ></div>
            <div
              className="absolute bottom-4 left-8 w-1 h-1 bg-yellow-200 rounded-full animate-ping"
              style={{ animationDelay: '1s' }}
            ></div>
            <div
              className="absolute bottom-2 right-4 w-2 h-2 bg-white rounded-full animate-ping"
