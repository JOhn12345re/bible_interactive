...
const menuItems = [
  {
    ...
    lessons: [
      ...
      {
        id: 'moise_01',
        title: 'Moïse et la traversée de la mer Rouge',
        path: 'Le Pentateuque',
        description: 'La libération miraculeuse du peuple d\'Israël de l\'esclavage.',
        book: 'Exode',
      },
  ...
  },
  {
    ...
    lessons: [
      ...
      // À ajouter : Isaïe, Jérémie, Lamentations, Ézéchiel, Daniel, Osée, Joël, Amos, Abdias, Michée, Nahum, Habacuc, Sophonie, Aggée, Zacharie, Malachie
    ],
  },
  {
    title: 'Vie du Christ',
    ...
    lessons: [
      ...
      // À ajouter : Baptême, Miracles, Passion, Résurrection
    ],
  },
  {
    title: 'Fêtes',
