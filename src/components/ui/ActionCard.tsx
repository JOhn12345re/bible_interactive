...
const ActionCard: React.FC<ActionCardProps> = ({ to, icon, title, description, colorClass, className = '' }) => {
  return (
    <Link
      to={to}
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="text-5xl mb-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">{icon}</div>
        <h3 className="text-2xl font-bold mb-2 group-hover:text-yellow-100 transition-colors duration-300">{title}</h3>
