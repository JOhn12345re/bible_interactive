  ...
  const games = [
    {
      ...
      description: 'Apprends les plus beaux versets avec des jeux de mémoire amusants.',
      emoji: '🧠',
      difficulty: 'Moyen',
      players: '1 joueur',
    ...
    },
    {
      ...
      description: 'Collectionne les éléments pour reproduire les miracles de Jésus !',
      emoji: '🏃‍♂️',
      difficulty: 'Moyen',
      players: '1 joueur',
      ...
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center text-white/80 group-hover:text-white transition-colors duration-300">
                      <span className="text-sm font-medium mr-2">Jouer maintenant</span>
                      <svg 
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center text-white/60">
                      <span className="text-sm font-medium mr-2">Bientôt disponible</span>
                      <svg 
                        className="w-4 h-4" 
                        fill="none" 
                        stroke="currentColor" 
        ...
        <div className={`mt-12 p-8 rounded-2xl text-center ${
          ...
          <p className={`text-lg mb-6 ${
            ...
            Nos développeurs travaillent dur pour créer les jeux les plus amusants pour toi ! 
          </p>
          ...
          <div className={`mt-6 p-4 rounded-xl ${
            ...
            <p className={`text-sm ${
              ...
              💡 <strong>Astuce :</strong> En attendant, explore les histoires bibliques pour débloquer tes premiers badges !
            </p>
          </div>
        </div>
      </main>
