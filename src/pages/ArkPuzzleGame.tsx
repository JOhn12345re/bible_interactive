...
const ArkPuzzleGame = () => {
      ...
      prev.map((p) =>
        p.id === draggedPiece
          ? {
              ...
              isPlaced:
                p.correctPosition.x === dropX && p.correctPosition.y === dropY,
            }
          : p
      )
    );
  ...
  const handlePieceClick = (pieceId: number) => {
    ...
    setPieces((prev) =>
      prev.map((p) =>
        p.id === pieceId ? { ...p, position: null, isPlaced: false } : p
      )
    );
  };
  ...
  if (gameWon) {
    return (
      <div
        className={`min-h-screen ${contrastHigh ? 'bg-contrast-bg text-contrast-text' : 'bg-gradient-to-br from-blue-50 via-white to-green-50'}`}
      >
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              ...
              <p
                className={`text-xl mb-6 ${contrastHigh ? 'text-contrast-text' : 'text-blue-600'}`}
              >
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              >
                <h3
                  className={`font-bold mb-3 ${contrastHigh ? 'text-contrast-text' : 'text-yellow-800'}`}
                >
                  📋 Comment jouer ?
                </h3>
                <div
                  className={`text-left space-y-2 ${contrastHigh ? 'text-contrast-text' : 'text-yellow-700'}`}
                >
                  <p>
                    <strong>1.</strong> 🖱️ <strong>Glisse</strong> les animaux
                    de l'inventaire (en bas) vers l'arche (en haut)
                  </p>
                  <p>
                    <strong>2.</strong> 🎯 Chaque animal a sa{' '}
                    <strong>place spécifique</strong> dans l'arche
                  </p>
                  <p>
                    <strong>3.</strong> ❌ Si tu veux retirer un animal,{' '}
                    <strong>clique dessus</strong> dans l'arche
                  </p>
                  <p>
                    <strong>4.</strong> 🏆 Place tous les 12 animaux pour gagner
                    !
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <p
                  className={`text-sm ${contrastHigh ? 'text-contrast-text' : 'text-blue-700'}`}
                >
                  "L'Éternel dit à Noé: Entre dans l'arche, toi et toute ta
                  maison... Tu prendras auprès de toi sept couples de tous les
                  animaux purs" - Genèse 7:1-2 (Louis Segond 1910)
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-6">
            <div
              className={`text-center ${contrastHigh ? 'text-contrast-text' : 'text-blue-600'}`}
            >
            ...
            >
              ...
              <div className="text-2xl font-bold">
                {pieces.filter((p) => p.isPlaced).length}/12
              </div>
            </div>
            <button
              onClick={resetGame}
            ...
            >
              ...
              >
                ...
                <div className="text-xs">
                  • <strong>Glisse</strong> les animaux de l'inventaire vers
                  l'arche
                  <br />• <strong>Clique</strong> sur un animal placé pour le
                  retirer
                </div>
              </div>
            </div>
              ...
              {pieces.filter((piece) => !piece.position).length === 0 && (
                ...
                >
                  ...
                  <div className="text-sm">
                    Tous les animaux sont dans l'arche !
                  </div>
                </div>
              )}
            </div>
