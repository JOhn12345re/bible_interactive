...
export default function TimelinePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-3 sm:py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2 sm:space-x-4">
            <Link
              to="/"
              className={`flex items-center space-x-1 sm:space-x-2 font-bold text-base sm:text-xl transition-colors ${
                contrastHigh
            ...
            <span
              className={`text-xs sm:text-sm ${contrastHigh ? 'text-contrast-text' : 'text-gray-500'}`}
            >
              → Frise Chronologique
            </span>
          </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <Link
              to="/"
              className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg font-medium text-xs sm:text-base transition-all ${
                contrastHigh
      ...
      {/* Pied de page */}
      <footer
        className={`mt-8 sm:mt-16 py-6 sm:py-8 border-t ${
