...
const TreasureHuntGame = () => {
  ...
  const treasureData: Treasure[] = [
    {
      ...
      explanation:
        "L'Arche de l'Alliance contenait les tables de pierre avec les Dix Commandements.",
    ...
    },
    {
      ...
      explanation:
        "David était le roi d'Israël, choisi par Dieu, qui a vaincu Goliath.",
    ...
    },
    {
      ...
      explanation:
        'La tunique de plusieurs couleurs que Jacob donna à Joseph provoqua la jalousie de ses frères.',
    ...
    },
    {
      ...
      explanation:
        "Dieu demanda à Moïse d'ôter ses sandales devant le buisson ardent.",
    ...
    },
    {
      ...
      answer: 'harpe david',
      explanation:
        'David jouait de la harpe pour apaiser le roi Saül et a écrit de nombreux psaumes.',
    ...
    },
    {
      ...
      answer: 'huile sainte',
      explanation:
        "L'huile d'onction était utilisée pour consacrer les rois et les prêtres.",
  ...
  const locationData: Location[] = [
    {
      ...
      emoji: '🏛️',
      description:
        "Le lieu le plus saint d'Israël, construit par le roi Salomon.",
      treasures: [1, 6],
    },
    {
      id: 2,
      ...
      emoji: '🏰',
      description:
        "Résidence des rois d'Israël, témoin de gloire et de conflits.",
      treasures: [2, 5],
    },
    {
      id: 3,
  ...
  const checkAnswerMatch = (
    ...
    const matchPercentage =
      matchingWords / Math.max(significantWords.length, 1);
  ...
  if (gameWon) {
    return (
      <div
        className={`min-h-screen ${contrastHigh ? 'bg-contrast-bg text-contrast-text' : 'bg-gradient-to-br from-yellow-50 via-white to-orange-50'}`}
      >
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              ...
              <p
                className={`text-xl mb-6 ${contrastHigh ? 'text-contrast-text' : 'text-yellow-600'}`}
              >
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <h1
                className={`text-3xl font-bold mb-6 ${contrastHigh ? 'text-contrast-text' : 'text-gray-800'}`}
              >
                Chasse au Trésor Biblique
              </h1>
              <p
                className={`text-xl mb-8 ${contrastHigh ? 'text-contrast-text' : 'text-gray-600'}`}
              >
                Explore les lieux saints et découvre les trésors de l'histoire
                biblique !
              </p>
              ...
              <div
                className={`mt-8 p-4 rounded-xl ${
                  contrastHigh ? 'bg-contrast-text/10' : 'bg-yellow-50'
                }`}
              >
                <h3
                  className={`font-bold mb-2 ${contrastHigh ? 'text-contrast-text' : 'text-yellow-800'}`}
                >
                  💡 Comment jouer ?
                </h3>
                <p
                  className={`text-sm ${contrastHigh ? 'text-contrast-text' : 'text-yellow-700'}`}
                >
                  Visite chaque lieu, clique sur les trésors cachés et résous
                  les énigmes bibliques pour les découvrir. Chaque trésor
                  raconte une histoire de la Bible (Louis Segond 1910) !
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-6">
            <div
              className={`text-center ${contrastHigh ? 'text-contrast-text' : 'text-yellow-600'}`}
            >
              <div className="text-sm">Tentatives</div>
              <div className="text-2xl font-bold">{attempts}</div>
            </div>
            <div
              className={`text-center ${contrastHigh ? 'text-contrast-text' : 'text-green-600'}`}
            >
              <div className="text-sm">Trouvés</div>
              <div className="text-2xl font-bold">
                {treasures.filter((t) => t.found).length}/6
              </div>
            </div>
            <button
              onClick={resetGame}
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="text-center mb-6">
                ...
                <p
                  className={`${contrastHigh ? 'text-contrast-text' : 'text-amber-700'}`}
                >
              ...
              {selectedTreasure ? (
                <>
                  <div className="text-center mb-6">
                    ...
                    <h3
                      className={`text-xl font-bold ${contrastHigh ? 'text-contrast-text' : 'text-yellow-800'}`}
                    >
                      Énigme du Trésor
                    </h3>
                  </div>
                  ...
                  >
                    <p
                      className={`text-sm font-medium ${contrastHigh ? 'text-contrast-text' : 'text-yellow-800'}`}
                    >
                  ...
                  {showClue && (
                    <div
                      className={`p-4 rounded-xl mb-4 ${
                        contrastHigh ? 'bg-contrast-text/20' : 'bg-blue-50'
                      }`}
                    >
                      <p
                        className={`text-sm ${contrastHigh ? 'text-contrast-text' : 'text-blue-800'}`}
                      >
                        💡 <strong>Indice:</strong>{' '}
                        {selectedTreasure.explanation}
                      </p>
                      <p
                        className={`text-xs mt-2 ${contrastHigh ? 'text-contrast-text/80' : 'text-blue-600'}`}
                      >
                ...
                <div className="text-center py-8">
                  ...
                  <h3
                    className={`text-xl font-bold mb-2 ${contrastHigh ? 'text-contrast-text' : 'text-yellow-800'}`}
                  >
                    Explore le lieu
                  </h3>
                  <p
