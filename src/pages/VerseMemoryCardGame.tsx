        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              ...
              <p
                className={`text-xl mb-6 ${contrastHigh ? 'text-contrast-text' : 'text-purple-600'}`}
              >
              ...
              >
                Tu connais maintenant {verseData.length} versets bibliques par
                cœur !
              </p>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              >
                Retrouve les paires verset-référence pour mémoriser la Parole de
                Dieu !
              </p>
              ...
              >
                <h3
                  className={`font-bold mb-2 ${contrastHigh ? 'text-contrast-text' : 'text-purple-800'}`}
                >
                  💡 Comment jouer ?
                </h3>
                <p
                  className={`text-sm ${contrastHigh ? 'text-contrast-text' : 'text-purple-700'}`}
                >
                  Clique sur les cartes pour les retourner. Trouve les paires
                  verset-référence. Mémorise en moins de coups possible pour
                  obtenir le meilleur badge !
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-6">
            <div
              className={`text-center ${contrastHigh ? 'text-contrast-text' : 'text-purple-600'}`}
            >
