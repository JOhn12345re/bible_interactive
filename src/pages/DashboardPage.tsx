    ...
    <div className={`min-h-screen ${contrastHigh ? 'bg-contrast-bg text-contrast-text' : 'bg-gradient-to-br from-blue-50 via-white to-purple-50'}`}>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="space-y-12">
          ...
          <section>
            <h3 className={`text-2xl font-bold mb-6 ${contrastHigh ? 'text-contrast-text' : 'text-gray-800'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">📖</div>
                <h3 className="text-xl font-bold mb-2">Plan de Lecture 365</h3>
                <p className="text-sm opacity-90">
              ...
              >
                <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">⭐</div>
                <h3 className="text-xl font-bold mb-2">Versets Thématiques</h3>
                <p className="text-sm opacity-90">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-2">Journal Spirituel</h3>
                <p className="text-sm opacity-90">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">🎮</div>
                <h3 className="text-xl font-bold mb-2">Mini-Jeux Éducatifs</h3>
                <p className="text-sm opacity-90">
              ...
              >
                <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">📚</div>
                <h3 className="text-xl font-bold mb-2">Leçons Interactives</h3>
                <p className="text-sm opacity-90">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">📝</div>
                <h3 className="text-xl font-bold mb-2">Éditeur Universel</h3>
                <p className="text-sm opacity-90">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">🎬</div>
                <h3 className="text-xl font-bold mb-2">Vidéos & Sermons</h3>
                <p className="text-sm opacity-90">
              ...
              >
                <div className="text-4xl mb-4 group-hover:scale-110 transition-transform">🔍</div>
                <h3 className="text-xl font-bold mb-2">Explorateur de Sujets</h3>
                <p className="text-sm opacity-90">
