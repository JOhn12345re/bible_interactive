...
const JournalPage = () => {
      ...
      const defaultEntries: JournalEntry[] = [
        {
          ...
          content: 'Aujourd\'hui j\'ai commencé à explorer Bible Interactive. L\'histoire de Jonas m\'a beaucoup plu !',
          emoji: '🐋',
        ...
        },
        {
          ...
          content: 'J\'ai noté ce beau verset : "Car Dieu a tant aimé le monde..." - Jean 3:16',
          emoji: '💖',
  ...
  const updateEntry = () => {
    if (!selectedEntry || !editForm.title.trim() || !editForm.content.trim()) return;

    const newEntries = entries.map(entry => 
      entry.id === selectedEntry 
        ? { ...entry, title: editForm.title.trim(), content: editForm.content.trim(), emoji: editForm.emoji }
        : entry
    );
    saveEntries(newEntries);
    setIsEditing(false);
  ...
  return (
    <div className={`min-h-screen ${contrastHigh ? 'bg-contrast-bg text-contrast-text' : 'bg-gradient-to-br from-sky-50 via-white to-cyan-50'}`}>
      {/* Header */}
          ...
          <div className="lg:col-span-2">
            {isCreating || isEditing ? (
              ...
              <div className={`rounded-2xl p-8 ${
                ...
                {(() => {
                  const entry = entries.find((e: JournalEntry) => e.id === selectedEntry);
                  return entry ? (
                    <>
              ...
              <div className={`rounded-2xl p-8 text-center ${
                ...
                <p className={`text-lg mb-8 ${
                  ...
                  C'est ton espace personnel pour noter tes pensées, tes prières et tes découvertes.
                  Sélectionne une entrée à gauche ou crée-en une nouvelle !
                </p>
