      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <ActionCard
            ...
            description="Explore la chronologie des événements bibliques."
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div className="text-left">
                  <h3 className={`font-bold ${contrastHigh ? 'text-contrast-text' : 'text-gray-800'}`}>
                    Outils Avancés
                  </h3>
                  ...
                  <button className={`p-4 rounded-xl text-left transition-all hover:scale-105 ${
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm opacity-90">Compare différentes versions</p>
                      </div>
                    </div>
                  </button>
                </div>
