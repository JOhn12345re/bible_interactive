...
class LXXApiService {
  ...
  private books: LXXBook[] = [
    ...
    {
      id: 'Lev',
      name_french: 'Lévitique',
      name_greek: 'Λευιτικόν',
      abbreviation: 'Lv',
      category: 'pentateuque',
    },
    {
    ...
    {
      id: 'Deut',
      name_french: 'Deutéronome',
      name_greek: 'Δευτερονόμιον',
      abbreviation: 'Dt',
      category: 'pentateuque',
    },
    {
    ...
    {
      id: '1Sam',
      name_french: '1 Samuel',
      name_greek: 'Βασιλειῶν Αʹ',
      abbreviation: '1S',
      category: 'historiques',
    },
    {
      id: '2Sam',
      name_french: '2 Samuel',
      name_greek: 'Βασιλειῶν Βʹ',
      abbreviation: '2S',
      category: 'historiques',
    },
    {
  ...
  private mockGreekVerses: Record<string, LXXVerse[]> = {
    'genesis_1_1-3': [
      ...
      },
      {
        ...
        morphology:
          'RA.NSF X N.NSF V.IAI3S A.NSM C A.NSM C N.NSN P RA.GSF N.GSF C N.NSN N.GSM V.IMI3S P RA.GSN N.GSN',
      },
      {
        book_id: 'Gen',
        chapter: 1,
    ...
    'jonas_1_1-3': [
      {
        ...
        transliteration:
          'kai egeneto logos kyriou pros Iōnan huion Amathi legōn',
        strong_numbers: [
          '2532',
          '1096',
          '3056',
      ...
      },
      {
        ...
        verse: 2,
        greek_text:
          'ἀνάστηθι καὶ πορεύθητι εἰς Νινευη τὴν πόλιν τὴν μεγάλην καὶ κήρυξον ἐν αὐτῇ ὅτι ἀνέβη ἡ κραυγὴ τῆς κακίας αὐτῆς πρὸς μέ',
        transliteration:
          'anastēthi kai poreuthēti eis Nineuē tēn polin tēn megalēn kai kēryxon en autē hoti anebē hē kraugē tēs kakias autēs pros me',
        strong_numbers: [
          '450',
          '2532',
          '4198',
        ...
        morphology:
          'V.AMD2S C V.APD2S P N.ASF RA.ASF N.ASF RA.ASF A.ASF C V.AAD2S P RD.DSF C V.AAI3S RA.NSF N.NSF RA.GSF N.GSF RD.GSF P RP.AS',
      },
      {
        book_id: 'Jon',
        chapter: 1,
        verse: 3,
        greek_text:
          'καὶ ἀνέστη Ἰωνας τοῦ φυγεῖν εἰς Θαρσις ἐκ προσώπου κυρίου καὶ κατέβη εἰς Ἰόππην καὶ εὗρεν πλοῖον πορευόμενον εἰς Θαρσις',
        transliteration:
          'kai anestē Iōnas tou phygein eis Tharsis ek prosōpou kyriou kai katebē eis Ioppēn kai heuren ploion poreuomenon eis Tharsis',
        strong_numbers: [
          '2532',
          '450',
          '2495',
        ...
        morphology:
          'C V.AAI3S N.NSM RA.GSN V.PAN P N.ASF P N.GSN N.GSM C V.AAI3S P N.ASF C V.AAI3S N.ASN V.PAPASN P N.ASF',
      },
    ],
  };
  ...
  private parseGreekVerse(rawVerse: string): LXXVerse | null {
    ...
    const greekText = greekData
      .replace(/<S>[^<]*<\/S>/g, '') // Supprimer Strong numbers
